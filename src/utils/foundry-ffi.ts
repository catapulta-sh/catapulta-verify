...
function recFindByExt(base: string, ext: string, files?: any, result?: any): string[] {
...
export const getSettingsByArtifact = async (
    ...
    let settings: EtherscanVerification = {} as EtherscanVerification;
    ...
    settings.apikey =
        etherscanApiKey || ETHERSCAN_API_KEYS[chainId] || process.env.ETHERSCAN_API_KEY || '';
