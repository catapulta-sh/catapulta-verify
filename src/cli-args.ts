...
export const args = parse<InputParams>(
    {
        ...
        rpcUrl: {
            ...
            optional: true,
            alias: 'r',
            description: 'RPC URL to fetch transaction details, mandatory to support for debug_traceTransaction. You can use Alchemy or Quicknode providers if available.',
        },
        etherscanUrl: {
            type: String,
            optional: true,
